...
- 真实感参数:image_strength=0.35, denoising_strength=0.45, face_weight=0.95
"""
...
def build_prompt(context: str) -> Tuple[str, str]:
    ...
    leg_quality_tags = "【腿部质量 - 最高优先级】完美腿部比例,标准人体结构,腿部细节清晰,膝盖结构正确,脚踝结构正确,腿部光影自然,腿部皮肤质感真实,腿部线条优美,正常腿长比例,双腿完整,腿部无畸形,【严禁】多腿,【严禁】三条腿,【严禁】四条腿,【严禁】多余腿,【严禁】畸形腿,【严禁】融合腿,【严禁】扭曲腿,【严禁】额外肢体,【严格限制】只有两条腿,【严格限制】双腿结构,【严格限制】正常人体下半身,【严格限制】单一双腿"
     ...
     # 质量标签 - 强调色彩自然和正确结构 + 小柔脸部一致性
    quality_tags = "8K 超高清，电影级布光，细节丰富，色彩自然柔和，低饱和度，真实色调，正确人体比例，妆容自然，素雅色彩，极低饱和度，完美腿部比例，腿部无畸形，腿部结构正确，【严格限制】正常人体结构，【严格限制】标准四肢，【严格限制】双腿双臂，【严禁】多余肢体，【严禁】多腿，【严禁】多手臂，【无水印 - 最高优先级】无水印，无文字，无字样，无 logo，无品牌标识，无 tag，无标记，纯净画面，【小柔专属脸部 - 最高优先级】完全使用小柔的脸，100% 小柔五官特征，保持小柔脸型，保持小柔眼睛形状，保持小柔鼻子特征，保持小柔嘴巴特征，完全保留小柔面部识别度，不要改变小柔的脸，不要生成其他人脸，只使用小柔的脸"
        ...
        try:
            ...
            payload = {
                ...
                'parameters': {
                    ...
                    'size': size_param,
                     # 真实感增强参数
                    'image_strength': 0.35,   # 参考图影响力(0.5-0.7 平衡真实度和还原度)
                    'denoising_strength': 0.45,   # 去噪强度(0.6-0.8 增加细节变化)
                     # 小柔面部一致性优化
                    'face_consistency': True,  # 启用人脸一致性保护
                    'face_weight': 0.95,        # 人脸权重(保持 80% 原脸特征)
                }
            }
